      ...
      >
        ...
        >
          {[...row1Images, ...row1Images].map((src, i) => (
            <div
              key={`r1-${i}`}
              className="relative w-72 h-48 md:w-96 md:h-72 lg:w-[480px] lg:h-[320px] rounded-2xl overflow-hidden shrink-0 border border-white/5"
            >
              <Image
                src={src}
                alt="Gallery image"
        ...
        <div className="flex flex-col items-center gap-4 p-8 bg-background/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl max-w-md w-full text-center">
          ...
          <div>
            ...
            <p className="text-sm text-text-muted leading-relaxed">
              Wiring up the external album integration. The full gallery
